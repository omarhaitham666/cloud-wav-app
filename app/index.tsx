        ...
        renderItem={({ item }) => (
          ...
          >
            <Image
              ...
              resizeMode="contain"
            />
            <Text className="text-white text-2xl text-center font-noto-arabic-semibold mb-3">
              {t(item.title)}
            </Text>
            <Text className="text-gray-50 text-center text-sm leading-5 font-noto-arabic">
              {t(item.description)}
            </Text>
          </View>
        )}
